...
case class Connection (
  id: Option[Int],  // id
user_id: Option[Int],  // ID of user that owns this correlation
...
update_requested_at: Option[Date],  // Time at which an update was requested by a user.
...
last_successful_updated_at: Option[Date],  // The time at which the connector was last successfully updated.
