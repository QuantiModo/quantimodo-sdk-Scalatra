...
reminderFrequency: Option[Int],  // Number of seconds between one reminder and the next
...
lastReminded: Option[Date],  // ISO 8601 timestamp for the last time a reminder was sent
lastTracked: Option[Date],  // ISO 8601 timestamp for the last time a measurement was received for this user and variable
...
updatedAt: Option[Date],  // When the record in the database was last updated. Use ISO 8601 datetime format. Time zone should be UTC and not local.
