...
durationOfAction: Option[Int],  // Estimated duration of time following the onset delay in which a stimulus produces a perceivable effect
fillingValue: Option[Int],  // fillingValue
...
onsetDelay: Option[Int],  // onsetDelay
